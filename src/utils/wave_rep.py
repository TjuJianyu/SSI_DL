...
#
# class AE_Model():
#     def __init__(self,cnn=True,dropout=0.1,shape=[200,100,100],input_size=266,activation=tf.nn.relu,strides=1,kernel_size = [12],filters =[4],pool_size=[4],pooltype='max',fromhidden=False ):
#
